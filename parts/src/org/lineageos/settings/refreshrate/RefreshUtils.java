...
public final class RefreshUtils {
    ...
    private static final float REFRESH_STATE_MAXIMUM = 90f;
    ...
    protected void getOldRate() {
        defaultMinRate = Settings.System.getFloat(mContext.getContentResolver(), KEY_MIN_REFRESH_RATE,
                REFRESH_STATE_DEFAULT);
        defaultMaxRate = Settings.System.getFloat(mContext.getContentResolver(), KEY_PEAK_REFRESH_RATE,
                REFRESH_STATE_DEFAULT);
